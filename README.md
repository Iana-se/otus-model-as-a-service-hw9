...
Скрины по заданию: в папке /screens



Команды которые помогли при дебаге подов: 
- kubectl describe pod otus-maas-76b9f474bd-7qqlc
- kubectl logs pod/otus-maas-7cb79bf949-zstst
